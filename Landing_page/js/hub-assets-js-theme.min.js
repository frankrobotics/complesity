  ...
  (window.liquidElements = ($) => {
    ...
    (window.$liquidSections = liquidIsElementor
      ...
      : $liquidSectionsWrapper
          ...
          .find(
            "> .vc_row, > .vc_section, > .vc_section > .vc_row, > .lqd-section-scroll-sections > .vc_row, > .vc_element"
          )),
      (t || e) &&
        liquidIsElementor &&
  ...
  createDetailsObj(t, e, i, s) {
    return new Promise((n) => {
      fastdom.measure(async () => {
        ...
        const d = liquidIsElementor
            ? i.element.closest(".main-footer")
            : i.parent,
        ...
        if (
          ...
          (r.isInFooter = liquidIsElementor
            ? null != d
            : d.classList.contains("main-footer")),
...
!(function ($) {
  ...
  (function ($) {
    ...
    class n {
      ...
      drawIndicators(t) {
        const e = undefined;
        $(
          `<div class="lqd-section-ind pos-abs pointer-events-none" style="width: ${t.rect.width}px; height: ${t.rect.height}px; border: 3px solid red; top: ${t.rect.y}px; left: ${t.rect.x}px; z-index: 10;"><span style="display: inline-block; background: var(--color-primary); color: #fff; padding: 0.35em 1em;">${t.luminosity}</span></div>`
        ).appendTo($liquidBody);
      }
    }
    $.fn[i] = function (t) {
  ...
  (function ($) {
    ...
    class i {
      constructor(i, s) {
        ...
        if (
          ...
          window.liquidCheckedFonts &&
            ...
            window.liquidCheckedFonts.indexOf(a.toLowerCase()) < 0)
        ) {
      ...
      playTitle(t) {
        const e = this.DOM.titles[this.currentSlide],
      ...
      playInfo(t) {
        const e = this.DOM.infos[this.currentSlide],
      ...
      playImages(t) {
        const e = this.DOM.images[this.currentSlide],
  ...
  (function ($) {
    ...
    class i {
      ...
      _addBgElement() {
        ...
        (this.$bgEl = $(
          `<div class="lqd-liquid-bg-el-wrap lqd-overlay pointer-events-none z-index--1 ${t}"><div class="lqd-liquid-bg-el ${e} pos-tl w-100 ${i} pointer-events-none"></div></div>`
        )),
  ...
  (function ($) {
    ...
    (t.prototype = {
      ...
      carouselMobileDots() {
        ...
        const { carouselEl: t } = this.options,
          e = undefined,
          i = [
            t
              ? this.$carouselEl.attr("id")
        ...
        const s = $(this.flickityData.pageDots.holder).clone(!0),
          n = $(
            `<div class="carousel-dots-mobile carousel-dots-style4 ${i.join(
              " "
            )}"></div>`
          );
        n.append(s),
        ...
        o.forEach((t, e) => {
          ...
          this.flickityData.on("select", (t) =>
            this.carouselMobileDotsClasslist.call(this, o[t], t)
          );
      },
      ...
      carouselDotsNumbers() {
        ...
        if ("circle" === e) {
          ...
          (s = $(
            '<div class="lqd-carousel-slides-numbers d-inline-flex pos-rel"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="152" viewBox="-2 0 154 150" class="w-100 h-100"><circle fill="none" cx="75" cy="75" r="74.5"/><path fill="none" stroke-dashoffset="' +
              this.carouselSlidesPathLength +
              '" stroke-dasharray="' +
              this.carouselSlidesPathLength +
          ...
          (s = $(
            '<div class="lqd-carousel-slides-numbers d-inline-flex pos-rel lqd-carousel-numbers-line"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke-width="2" width="200" height="1" viewBox="0 0 200 1" class="w-100 h-100"><path opacity="0.15" d="M1 1 201 1 201 2 1 2z"></path><path stroke-dashoffset="' +
              this.carouselSlidesPathLength +
              '" stroke-dasharray="' +
              this.carouselSlidesPathLength +
      ...
      addSlidesCurrentNumbers() {
        ...
        const { flickityData: t } = this,
          ...
          i = "line" === e,
          s = $(
            '<div class="lqd-carousel-slides-current-inner d-inline-block" />'
          );
        for (let e = 1; e <= t.slides.length; e++)
          s.append(
            `<span class="d-inline-block" style="width: auto; text-indent: 0;">${
              e < 10 && i ? "0" : ""
            }${e}</span>`
          );
        setTimeout(() => {
      ...
      changeSlidesNumbers() {
        ...
        this.$carouselCurrentSlide.css("width", $(i).outerWidth(!0)),
      ...
      ($.fn[e] = function (i) {
        return this.each(function () {
          const s = { ...$(this).data("lqd-flickity"), ...i };
          s.pageDots
            ? (s.hasPageDotsFromOptions = !0)
            : (s.hasPageDotsFromOptions = !1),
            (s.pageDots = !0),
            $.data(this, "plugin_" + e) ||
              $.data(this, "plugin_" + e, new t(this, s));
        });
  ...
  jQuery(document).ready(function ($) {
    const t = document.body.hasAttribute("data-disable-carousel-onmobile"),
      e = $("[data-lqd-flickity]");
    liquidIsMobile() && t
      ? e.find(".flickity-viewport").css("overflow-x", "auto")
      : e.liquidCarousel();
  }),
  (function ($) {
    "use strict";
      ...
      .filter((t, e) => {
        ...
        return !(
          ...
          (i.closest(".main-header").length &&
            $liquidBody.hasClass("header-style-side")) ||
          i.parent().hasClass("lqd-mobile-main-nav") ||
    ...
    (t.prototype = {
      ...
      formatCounterAnimator: function (t) {
        return t
          ...
          .replace(
            /(\d)/g,
            '<span class="lqd-counter-animator d-inline-flex pos-rel overflow-hidden"><span class="lqd-animator-value">$1</span></span>'
          );
      },
    ...
    class i {
      ...
      initMarkup() {
        ...
        const t = $('<div class="lqd-css-sticky-wrap w-100 pos-rel" />'),
          e = $(
            '<div class="lqd-css-sticky-wrap-inner w-100 h-200 pos-abs pos-tl" />'
          );
  ...
  (function ($) {
    ...
    class o {
      ...
      addTableClass(t) {
        const e = $(t);
        e.addClass("d-flex flex-column flex-nowrap align-content-start"),
  ...
  (function ($) {
    ...
    class i {
      ...
      createNav() {
        this.DOM.$nav = $(
          '<div class="lqd-sticky-stack-nav h-100 pos-abs pos-tl" />'
        );
        const t = $(
          '<ul class="reset-ul lqd-css-sticky d-flex flex-column justify-content-center h-vh-100" />'
        );
    ...
    class i {
      constructor(i, s) {
        (this._defaults = e),
          ...
          (this.$activeItem = this.$navItems.filter((t, e) =>
  ...
  jQuery(document).ready(function ($) {
    "undefined" != typeof tab && $(".lqd-tabs").liquidTab();
  }),
  (function ($) {
    "use strict";
    ...
    class i {
      ...
      addZIndex() {
        (window.liquidParams.currentZIndex += 1),
          ...
          gsap.set(this.element, { zIndex: window.liquidParams.currentZIndex });
      }
      removeZIndex() {
        const { duration: t } = this.options;
  ...
  (function ($) {
    ...
    class o {
      ...
      async getOffsets() {
        const { offsetElements: t, includeParentAsOffset: e } = this.options;
        let s = i;
        if (!t) return s;
      ...
      events(e, i) {
        $(i).on("click", { itemIndex: e }, this.onClick.bind(this)),
          this.options.trackWindowScroll &&
            !t &&
            (this.onScroll(),
      ...
      checkIsInView(t, e = this.getScrollPos()) {
        return (
          (t.offsetTop > e[0] && t.offsetTop < e[1]) ||
          (t.offsetTop + t.offsetHeight > e[0] &&
            t.offsetTop + t.offsetHeight < e[1]) ||
          (t.offsetTop < e[0] && t.offsetTop + t.offsetHeight > e[1])
        );
      }
      getScrollPos() {
        let t, e;
      ...
      _measure() {
        return fastdomPromised.measure(() => {
          ...
          (this.fontInfo.elementFontFamily = t.fontFamily
            ...
            (this.fontInfo.lowecaseFontFamily =
              this.fontInfo.elementFontFamily.toLowerCase());
        });
      }
      _onFontsLoad() {
        return fastdomPromised.measure(() => {
          if (
            window.liquidCheckedFonts &&
            window.liquidCheckedFonts.length &&
            window.liquidCheckedFonts.indexOf(
              this.fontInfo.lowecaseFontFamily
            ) >= 0
          )
    ...
    class i {
      constructor(i, s) {
        ...
        if (n.length && null != n.attr("data-ca-options")) {
          const t = undefined;
          JSON.parse(n.attr("data-ca-options")).addChildTimelines &&
            (this.shouldPause = !0);
        }
      ...
      _getAnimationTargets() {
        const { direction: t, animationTarget: e } = this.options;
        let i = null;
        switch (e) {
          case "this":
            i = this.element;
        ...
        (this.animationTargets = Array.from(i)),
          "backward" === t
            ? (this.animationTargets = this.animationTargets.reverse())
            : "random" === t &&
              (this.animationTargets = gsap.utils.shuffle(
                this.animationTargets
              ));
      }
      _getChildElments() {
      ...
      async _getChildTimelines() {
        const e = [];
        if (
          (this.animationTargets.forEach((i, s) => {
            const n = $(i);
            let o = n;
            n.hasClass("elementor-widget-container") && (o = n.parent());
            const a = o.data(`plugin_${t}`);
            a &&
              a.animationsInitiatedPromise &&
              (e[s] = a.animationsInitiatedPromise);
          }),
          e.length > 0)
        ) {
          const t = undefined;
          (await Promise.all(e)).forEach((t, e) => {
            t &&
              t.animationsTimeline &&
              this.animationTargets.splice(e + 1, 0, t.animationsTimeline);
          });
        }
      }
      _initValues() {
      ...
      async _runAnimations() {
        ...
        s && (await this._getChildTimelines()),
          this.animationTargets.forEach((s, n) => {
            s.vars
              ? (s.restart(!0), this.animationsTimeline.add(s, "<"))
              : this.animationsTimeline.to(
                  s,
                  {
                    ...i,
                    onStart: () => {
        ...
        return fastdomPromised.mutate(() => {
          (this.sentinel = document.createElement("div")),
            this.sentinel.setAttribute(
              "class",
              "lqd-parallax-sentinel pointer-events-none pos-abs z-index--1 invisible"
            ),
